...
?>
<!doctype html><html><head><meta charset="utf-8"><title>Admin Chat</title><link rel="stylesheet" href="../assets/css/style.css"></head><body class="layout">
...
document.getElementById('msgForm').addEventListener('submit', async function(e){
  ...
  if(!t) return;
  await fetch('../ajax/chat_send.php',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body:'message='+encodeURIComponent(t)+'&sender=admin'});
